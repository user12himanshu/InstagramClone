...
class PhnDateofBirth extends StatefulWidget {
  const PhnDateofBirth({Key? key}) : super(key: key);

  @override
  _PhnDateofBirthState createState() => _PhnDateofBirthState();
}

class _PhnDateofBirthState extends State<PhnDateofBirth> {
  String? date;
  @override
